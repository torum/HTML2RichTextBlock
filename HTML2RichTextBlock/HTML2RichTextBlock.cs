...
public class HtmlProperties : DependencyObject
{
    ...
    private static void HtmlChanged(DependencyObject d, DependencyPropertyChangedEventArgs e)
    {
        ...
        {
            Debug.WriteLine("Exception@HtmlChanged: " + ex);
        }
    }
    ...
    private static List<Block> GenerateBlocksForHtml(string xhtml)
    {
        ...
        {
            Debug.WriteLine("Exception@GenerateBlocksForHtml: " + ex.Message);
        }
    ...
    private static Inline GenerateImage(HtmlNode node)
    {
        ...
        {
            Debug.WriteLine("Exception@GenerateImage: " + ex.Message);
        }
    ...
    private static Inline? GenerateImageWithHyperLink(HtmlNode node)
    {
        ...
        {
            Debug.WriteLine("Exception@GenerateImageWithHyperLink: " + ex.Message);
        }
        return span;
    }
    ...
    private static void ImageOpened(object sender, RoutedEventArgs e)
    {
        ...
        {
            Debug.WriteLine("Exception@ImageOpened: " + ex.Message);
        }
    }
    ...
    private static Inline? GenerateHyperLink(HtmlNode node)
    {
        ...
        {
            Debug.WriteLine("Exception@GenerateHyperLink: " + ex.Message);
            return null;
        }
    }
    ...
    private static Inline? GenerateIFrame(HtmlNode node)
    {
        ...
        {
            Debug.WriteLine("Exception@GenerateIFrame: " + ex.Message);
            return null;
        }
    }
